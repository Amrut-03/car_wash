...
class _CustomWashtypeWidgetState extends ConsumerState<CustomWashtypeWidget> {
  ...
  final TextEditingController suvPrice = TextEditingController();
  final TextEditingController hackBackPrice = TextEditingController();
  final TextEditingController sedanPrice = TextEditingController();
  ...
  // @override
  // void didUpdateWidget(covariant CustomWashtypeWidget oldWidget) {
